...
class OtherActivitiesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_other_activities, container, false)
        listView = view.findViewById(R.id.otherActivitiesListView)
        fetchOtherActivities()
        return view
    }

    private fun fetchOtherActivities() {
